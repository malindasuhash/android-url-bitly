 ...
 ** 
 */
package uk.co.blogspot.mycodingnotebook.theshortenurl.Remote;
            ...
            if (!loggedIn) {
                try {
                   ...
                   // to.addField("username", username);
                    ...
                    String base64EncodedAuth = Base64.encodeToString(data, Base64.DEFAULT);

                    // Add the basic authorization header
                    List<Header> headers = new ArrayList<Header>();
                    headers.add(new Header("Authorization", "Basic " + base64EncodedAuth));
